import type {WlffMuddTraillsGuideAnimalImageKey} from './WlffMuddTraillsGuideAnimalImages';

export type WlffMuddTraillsGuideAnimal = {
  id: WlffMuddTraillsGuideAnimalImageKey;
  name: string;
...
export const WlffMuddTraillsGuideAnimals: WlffMuddTraillsGuideAnimal[] = [
  {
    id: 'wolf',
    name: 'Wolf',
...
export function WlffMuddTraillsGetGuideAnimal(id: string): WlffMuddTraillsGuideAnimal | undefined {
  return WlffMuddTraillsGuideAnimals.find(animal => animal.id === id);
}
