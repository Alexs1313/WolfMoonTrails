import type {GuideAnimalImageKey} from './guideAnimalImages';

export type GuideAnimal = {
  id: GuideAnimalImageKey;
  name: string;
...
export function getGuideAnimal(id: string): GuideAnimal | undefined {
  return guideAnimals.find(animal => animal.id === id);
}
